...
import com.jspiders.elibrary.database.BookDb;
import com.jspiders.elibrary.entity.BookBean;
import com.jspiders.elibrary.entity.IssueBookBean;
...
public class ViewIssuedBook extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<IssueBookBean> list=BookDb.viewIssuedBooks();
